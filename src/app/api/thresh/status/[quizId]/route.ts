...
} from '@/features/quiz/dtos/response/quizStatusResDto';
...
export const GET = async (
  _: Request,
  context: Params,
): Promise<NextResponse<Result<QuizStatusResDto>>> => {
  try {
    ...
    const apiResponse: ApiResponse<QuizStatusResDto> = await quizStatusSource(
      quizId,
      storedAccessToken,
    );
