...
import { ALREADY_HARVESTED_INSIGHT_ERROR } from '@/features/insight/constants/errorMessage';
import { HarvestInsightReqDto } from '@/features/insight/dtos/request/harvestInsightReqDto';

const harvestInsightSource = async (
  body: HarvestInsightReqDto,
  accessToken: string,
): Promise<void> => {
